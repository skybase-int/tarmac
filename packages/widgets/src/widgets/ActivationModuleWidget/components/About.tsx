...
// TODO: This copy is temporary and will be replaced with the final copy once the Activation Engine is launched
export const About = () => {
  return (
    <div className="mb-4">
      <Heading variant="medium">
        <Trans>About the Activation Engine</Trans>
      </Heading>
      <Text className="mt-4">
        <Trans>The SKY tokens you supply to the Activation Engine are sealed behind an exit fee</Trans>{' '}
        <InfoTooltip
          content={
            <>
              <Text>
                When you supply SKY to the Activation Engine, a position is created and those tokens are
              ...
              <Text>
                ...
                it is determined the moment you unseal your SKY.
              </Text>
              <br />
              <Text>
                The moment the Activation Engine launched, the exit fee rate was set to 5% of the value of the
                SKY tokens that you have sealed, with a planned 1% increase every 6 months thereafter until it
                reaches the long-term fee rate of 15%.
              </Text>
            </>
          }
      ...
      <ol className="mt-4 list-outside list-decimal space-y-2 pl-4">
        <li>
          <Text tag="span">
            <Trans>Borrow USDS against your SKY</Trans>{' '}
            <InfoTooltip
              contentClassname="max-w-[400px]"
        ...
        <li>
          <Text tag="span">
            <Trans>Transfer the voting power of your SKY tokens to a recognized delegate</Trans>{' '}
            <InfoTooltip
              content={
                <Text>
                  ...
                  <br />
                  <br />
                  The voting power delegation feature of the Activation Engine of the Sky Protocol enables you
                  to entrust your voting power to a delegate of your choosing, who can then vote in the Sky
                  ecosystem governance process on your behalf. You can choose one delegate per sealed SKY
                  position. If you want to entrust your SKY to two delegates using the Activation Engine, you
                  will need to create two separate positions.
                  <br />
                  <br />
      ...
      <Text className="mt-4">
        <Trans>
          ...
          contract, such that no intermediary takes custody of those tokens. With Sky, you always remain in
