...
export const SaRewardsCard = ({
  ...
  const { data: activationRewardsData, isLoading: isActivationRewardsDataLoading } = useSealRewardsData();

  const contractRewardsData = activationRewardsData?.find(
    ...
    <StatsOverviewCardCoreAccordion
      ...
      headerRightContent={
        <MotionHStack className="items-center" gap={2} variants={positionAnimations}>
          ...
          ) : isActivationRewardsDataLoading ? (
