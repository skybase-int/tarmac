...
import { DelegateCard } from '@widgets/widgets/StakeModuleWidget/components/DelegateCard';
...
export const MigrateSelectDelegate = ({
  ...
  // Use the stake hook here because we're opening a staking position and need the stake delegates
  ...
  useEffect(() => {
    setIsSelectDelegateCompleted(hasCompletedMigrateFlow);
  }, [hasCompletedMigrateFlow]);
