...
The SKY Borrow Rate is the current interest rate charged to SKY-backed borrowers and is dynamic and market-driven, based on the utilization of funds within the stUSDS contract.`
  ...
  },
  {
    ...
    tooltip:
      'Native USDS liquidity on Ethereum is currently 100% utilized. As a result, supplying to or withdrawing from the stUSDS module using the native route is temporarily disabled.'
  },
  {
