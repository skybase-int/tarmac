...
export function ConnectCard({ intent }: { intent: Intent }) {
  ...
  const contentText = {
    ...
    [Intent.STUSDS_INTENT]: t`stUSDS allows you to earn a variable rate on your USDS by participating in SKY-backed borrowing. The rate fluctuates based on borrowing demand, offering higher returns than the standard Sky Savings Rate. Note that withdrawals may be delayed during periods of high utilization. stUSDS is only available on Ethereum mainnet.`,
