...
export function ConnectCard({ intent }: { intent: Intent }) {
  ...
  const heading = {
    ...
    [Intent.ACTIVATION_INTENT]: t`About Activation Engine`
  };
  ...
  const contentText = {
    ...
    [Intent.ACTIVATION_INTENT]: t`The Activation Engine is a module of the Sky Protocol. The SKY token you supply to the Activation Engine are sealed behind an exit fee in order to provide access to Activation Rewards and encourage a deeper commitment to Sky ecosystem governance. With Sky, you always remain in control of your funds.`
  };
