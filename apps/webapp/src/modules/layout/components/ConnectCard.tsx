...
export function ConnectCard({ intent }: { intent: Intent }) {
  ...
  const contentText = {
    [Intent.BALANCES_INTENT]: getChainSpecificText(
      {
        base: t`Balances displays all of your Sky-related funds available on the Base network. When you connect your crypto wallet to Sky.money to access the decentralised Sky Protocol, only the tokens in the wallet that are relevant to the app on Base are listed. With this visibility, you can better self-manage your funds. Sky.money is non-custodial and permissionless.`,
        arbitrum: t`Balances displays all of your Sky-related funds available on the Arbitrum network. When you connect your crypto wallet to Sky.money to access the decentralised Sky Protocol, only the tokens in the wallet that are relevant to the app on Arbitrum are listed. With this visibility, you can better self-manage your funds. Sky.money is non-custodial and permissionless.`,
        optimism: t`Balances displays all of your Sky-related funds available on the Optimism network. When you connect your crypto wallet to Sky.money to access the decentralised Sky Protocol, only the tokens in the wallet that are relevant to the app on Optimism are listed. With this visibility, you can better self-manage your funds. Sky.money is non-custodial and permissionless.`,
        unichain: t`Balances displays all of your Sky-related funds available on the Unichain network. When you connect your crypto wallet to Sky.money to access the decentralised Sky Protocol, only the tokens in the wallet that are relevant to the app on Unichain are listed. With this visibility, you can better self-manage your funds. Sky.money is non-custodial and permissionless.`,
    ...
    [Intent.SAVINGS_INTENT]: getChainSpecificText(
      {
        base: t`The experience of supplying stablecoins to the Savings feature on Base and Ethereum is very similar. However, given that no native Sky Savings Rate module is deployed to Base, when transacting on Base you always interact with the Peg Stability Module (PSM) for conversions to/from USDS, sUSDS and USDC. The PSM on Base handles conversions programmatically, driven at your direction, between these pairs directly.`,
        arbitrum: t`Supplying stablecoins to the Savings feature on either Arbitrum or Ethereum is very similar. However, given that no native Sky Savings Rate module is currently deployed to Arbitrum, when transacting on Arbitrum you always interact with the Peg Stability Module (PSM) for conversions to/from USDS, sUSDS and USDC. The PSM on Arbitrum handles conversions programmatically, driven at your direction, between these pairs directly.`,
        optimism: t`Supplying stablecoins to the Savings feature on either Optimism or Ethereum is very similar. However, given that no native Sky Savings Rate module is currently deployed to Optimism, when transacting on Optimism you always interact with the Peg Stability Module (PSM) for conversions to/from USDS, sUSDS and USDC. The PSM on Optimism handles conversions programmatically, driven at your direction, between these pairs directly.`,
        unichain: t`Supplying stablecoins to the Savings feature on either Unichain or Ethereum is very similar. However, given that no native Sky Savings Rate module is currently deployed to Unichain, when transacting on Unichain you always interact with the Peg Stability Module (PSM) for conversions to/from USDS, sUSDS and USDC. The PSM on Unichain handles conversions programmatically, driven at your direction, between these pairs directly.`,
    ...
    [Intent.TRADE_INTENT]: getChainSpecificText(
      {
        base: t`On Base, you can convert between USDS, sUSDS and USDC through a Peg Stability Module (PSM) deployed to the Base blockchain and powered by Spark. The PSM on Base handles conversions programmatically, driven at your direction. PSMs are smart contracts designed to maintain the stability of stablecoins and allow users to convert certain stablecoins directly with the Sky Protocol at a fixed rate and with no fees. However, blockchain (gas) fees may apply.`,
        arbitrum: t`On Arbitrum, you can convert between USDS, sUSDS and USDC through a Peg Stability Module (PSM) deployed to Arbitrum and powered by Spark. The PSM on Arbitrum handles conversions programmatically, driven at your direction. PSMs are smart contracts designed to maintain the stability of stablecoins and allow users to convert certain stablecoins directly with the Sky Protocol at a fixed rate and with no fees. However, blockchain (gas) fees may apply.`,
        optimism: t`On Optimism, you can convert between USDS, sUSDS and USDC through a Peg Stability Module (PSM) deployed to Optimism and powered by Spark. The PSM on Optimism handles conversions programmatically, driven at your direction. PSMs are smart contracts designed to maintain the stability of stablecoins and allow users to convert certain stablecoins directly with the Sky Protocol at a fixed rate and with no fees. However, blockchain (gas) fees may apply.`,
        unichain: t`On Unichain, you can convert between USDS, sUSDS and USDC through a Peg Stability Module (PSM) deployed to Unichain and powered by Spark. The PSM on Unichain handles conversions programmatically, driven at your direction. PSMs are smart contracts designed to maintain the stability of stablecoins and allow users to convert certain stablecoins directly with the Sky Protocol at a fixed rate and with no fees. However, blockchain (gas) fees may apply.`,
