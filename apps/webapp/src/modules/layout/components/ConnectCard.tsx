...
export function ConnectCard({ intent }: { intent: Intent }) {
  ...
  const contentText = {
    ...
    [Intent.SAVINGS_INTENT]: isBaseChain
      ? t`The experience of supplying stablecoins to the Savings widget on Base and Ethereum is very similar. However, given that no native Sky Savings Rate module is deployed to Base, when on Base you always interact with the Peg Stability Module (PSM) for conversions to/from USDS, sUSDS and USDC.`
