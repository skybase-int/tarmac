...
export function ConnectCard({ intent }: { intent: Intent }) {
  ...
  const heading = {
    ...
    [Intent.STAKE_INTENT]: t`About Stake Engine`
  };
  ...
  const contentText = {
    ...
    [Intent.STAKE_INTENT]: t`The Stake Engine is a module of the Sky Protocol. The SKY token provides access to Stake Rewards and encourage a deeper commitment to Sky ecosystem governance. With Sky, you always remain in control of your funds.`
  };
