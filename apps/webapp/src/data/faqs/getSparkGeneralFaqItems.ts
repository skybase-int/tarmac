export const getSparkGeneralFaqItems = () => {
  const items = [
    ...
    },
    {
      ...
      answer:
        '[Spark.fi](http://Spark.fi) enables users to easily deposit stablecoins into its Savings product and receive Savings USDS (sUSDS) tokens in return. The sUSDS tokens users receive represent their shares of USDS in the Sky Savings Rate. As savings accrue over time, the sUSDS increases in value. The Sky Savings Rate is set by Sky Ecosystem Governance through the process of decentralized onchain voting.',
      index: 2
    },
    {
      question: 'What is SparkLend?',
      answer:
        'SparkLend is a decentralized non-custodial liquidity market protocol that powers the Spark Borrow product. It sources liquidity directly from Sky to provide the best borrow rates for USDS. Through [Spark.fi](http://Spark.fi), Spark Borrow users can participate as lenders or borrowers: lenders provide liquidity to the market to earn a passive income as their assets are lent out, while borrowers are able to borrow in an overcollateralized and perpetual fashion.',
      index: 3
    },
    {
