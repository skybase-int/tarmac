...
export const waitForVnetsReady = async () => {
  // Wait 30 seconds before checking network readiness to allow vnets to initialize
  // console.log('Faking the virtual network readiness check...');
  // await new Promise(resolve => setTimeout(resolve, 15000));
  // console.log('Faking virtual network readiness check finished...');
